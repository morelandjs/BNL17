...
\begin{frame}[plain]
  \begin{columns}
    ...
    \begin{itemize}
      \item<1-2>[\scshape \color{theme} Part I:] Bayesian analysis of entropy deposition in relativistic nuclear collisions\\[2ex]
      \item<1>[\scshape \color{theme} Part II:] Using Bayesian methods to explore nucleon substructure
    \end{itemize}
    }%
    \end{column}
  \end{columns}
...
\begin{frame}[plain]
  \begin{columns}
    ...
    \setbeamercovered{transparent=50}
    \begin{itemize}
      \item<0>[\scshape \color{theme} Part I:] Bayesian analysis of entropy deposition in relativistic nuclear collisions\\[2ex]
      \item<1>[\scshape \color{theme} Part II:] Using Bayesian methods to explore nucleon substructure
    \end{itemize}
    }%
    \end{column}
...
\begin{frame}{What if we apply same models to small systems?}
  \centering
  ...
  \begin{itemize}
    ...
    \item<1> SONIC model works well, but deviates from Pb+Pb observables
...
\begin{frame}{E.g.\ substructure effect on nuclear thickness func's}
  \smallskip
  \begin{columns}
    \begin{column}{.02\textwidth}
...
\begin{frame}{Adding proton-lead observables}
\end{frame}
