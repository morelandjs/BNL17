...
\begin{frame}
  \begin{columns}
    ...
    \centering
      {\Large \scshape \color{theme} This work:}\\[1ex]
    \begin{itemize}
      \item Implement parametric nucleon substructure within \trento\ initial condition model
...
\begin{frame}[plain]
  \centering \Large \color{theme} \scshape Backup Slides
\end{frame}
