...
\title[]{Applying Bayesian methodology to study particle production and nucleon structure in relativistic nuclear collisions}
...
\begin{frame}{What's the best the model can do?}
\end{frame}

\begin{frame}{What does the model predict for a p+p collision?}
\end{frame}
